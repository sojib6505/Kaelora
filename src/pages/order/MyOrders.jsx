...
// Fresh axios without interceptor
                ...
                >
                  ...
                  <div className="flex gap-2 mb-3">
                    {order.items?.slice(0, 3).map((item, i) => (
                      <div
                        key={i}
                        className="w-12 h-12 rounded-lg overflow-hidden bg-gray-50 border shrink-0"
                      >
                        {item.productImage ? (
                          <img
            ...
            <div className="space-y-3">
              {order.items?.map((item, i) => (
                <div key={i} className="flex gap-3 items-center">
                  <div className="w-14 h-14 rounded-xl overflow-hidden bg-gray-50 border shrink-0">
                    {item.productImage ? (
                      <img
                        src={item.productImage}
                        alt={item.productName}
