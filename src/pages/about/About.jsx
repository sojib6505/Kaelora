      ...
      <div className="min-h-screen bg-[#faf9f7] text-[#24211f]">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 md:grid-cols-2 md:px-10 lg:px-16 lg:py-28">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-7 max-w-lg text-base leading-8 text-gray-600 md:text-lg">
                Where timeless elegance meets your individual style. AK
                Signature Wear is dedicated to bringing beautiful ladies' attire
                that makes every woman feel confident, comfortable and
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-4xl">
                <img
                  ...
                  className="h-130 w-full object-cover transition duration-700 hover:scale-105 sm:h-150"
                />
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 md:px-10 lg:px-16 lg:py-28">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {/* Card 1 */}
            <div className="group rounded-3xl border border-black/5 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/5">
        ...
        <section className="relative overflow-hidden bg-[#292522]">
          ...
          <div className="relative mx-auto max-w-5xl px-6 py-24 text-center md:py-32">
            ...
            <h2 className="mt-6 font-serif text-4xl leading-tight text-white sm:text-5xl md:text-6xl">
              Your style.
              <br />
              <span className="italic text-[#c9a99a]">Your signature.</span>
            </h2>
        ...
        <section className="bg-[#faf9f7]">
          <div className="mx-auto max-w-4xl px-6 py-20 text-center md:py-24">
            ...
            <p className="mt-4 text-sm text-gray-500">+88 01621234852</p>
          </div>
        </section>
